...
class TestCanChecksums(unittest.TestCase):
  ...
  def test_volkswagen_mlb_crc_epb_01(self):
    # XOR checksum, seed 0x05 = (addr & 0xFF) - 1 + 2. Real frames captured from an Audi Q5 8R (MLB).
    self.verify_volkswagen_mlb_crc("EPB_01", 0x104, [
    b'\x13\x00\xa6\x81\x00\x00\x00\x31',
    b'\x13\x01\xa6\x80\x00\x00\x00\x31',
    b'\x10\x02\xa6\x80\x00\x00\x00\x31',
    b'\x11\x03\xa6\x80\x00\x00\x00\x31',
    b'\x16\x04\xa6\x80\x00\x00\x00\x31',
    b'\x17\x05\xa6\x80\x00\x00\x00\x31',
    b'\x15\x06\xa6\x81\x00\x00\x00\x31',
    b'\x14\x07\xa6\x81\x00\x00\x00\x31',
    b'\x1b\x08\xa6\x81\x00\x00\x00\x31',
    b'\x1a\x09\xa6\x81\x00\x00\x00\x31',
    b'\x19\x0a\xa6\x81\x00\x00\x00\x31',
    b'\x19\x0b\xa6\x80\x00\x00\x00\x31',
    b'\x1f\x0c\xa6\x81\x00\x00\x00\x31',
    b'\x1d\x0d\xa6\x82\x00\x00\x00\x31',
    b'\x1c\x0e\xa6\x80\x00\x00\x00\x31',
    b'\x1c\x0f\xa6\x81\x00\x00\x00\x31',
    ])

  def test_volkswagen_mlb_crc_esp_01(self):
    # XOR checksum, seed 0xAB (VW magic Startwert). Real frames captured from an Audi Q5 8R (MLB).
  ...
  def test_volkswagen_mlb_crc_esp_02(self):
    # XOR checksum, seed 0xAA (VW magic Startwert). Real frames captured from an Audi Q5 8R (MLB).
    self.verify_volkswagen_mlb_crc("ESP_02", 0x101, [
    b'\xe8\x80\x7c\x06\xfe\x06\x40\x00',
    b'\xfa\x81\x7d\x06\xfe\x14\x40\x00',
    b'\x0d\x82\x80\x02\xfe\x19\x40\x00',
    b'\xe7\x83\x7e\x02\xfe\x0c\x40\x00',
    b'\xe3\x84\x7e\x03\xfe\x0e\x40\x00',
    b'\xe2\x85\x7e\x03\xfe\x0e\x40\x00',
    b'\xe2\x86\x7f\x04\xfe\x0b\x40\x00',
    b'\xe2\x87\x7e\x04\xfe\x0b\x40\x00',
    b'\xed\x88\x7d\x04\xfe\x08\x40\x00',
    b'\xec\x89\x7d\x05\xfe\x09\x40\x00',
    b'\xed\x8a\x7f\x05\xfe\x09\x40\x00',
    b'\xe4\x8b\x7f\x03\xfe\x07\x40\x00',
    b'\xf3\x8c\x7d\x06\xfe\x10\x40\x00',
    b'\xef\x8d\x7c\x07\xfe\x0d\x40\x00',
    b'\xe9\x8e\x7f\x03\xfe\x0f\x40\x00',
    b'\xe7\x8f\x7f\x02\xfe\x01\x40\x00',
    ])
  ...
  def test_volkswagen_mlb_crc_acc_04(self):
    self.verify_volkswagen_mlb_crc("ACC_04", 0x324, [
  ...
  def test_volkswagen_mlb_crc_acc_05(self):
    self.verify_volkswagen_mlb_crc("ACC_05", 0x10D, [
  ...
  def test_volkswagen_mlb_crc_esp_03(self):
    self.verify_volkswagen_mlb_crc("ESP_03", 0x103, [
        ...
        b'\x03\x01\x59\x82\x25\x59\x82\x25',
        b'\xe0\x02\x59\x92\x25\x59\x72\x25',
        b'\xe1\x03\x59\x92\x25\x59\x72\x25',
        b'\x24\x04\x5b\xb2\x25\x59\x92\x25',
        b'\x37\x05\x59\x92\x25\x59\xa2\x25',
        b'\x06\x06\x59\x92\x25\x5b\x92\x25',
        b'\x06\x07\x5a\x92\x25\x59\x92\x25',
        b'\x2b\x08\x5b\xa2\x25\x5a\x82\x25',
        b'\x3a\x09\x5b\xb2\x25\x5a\x82\x25',
        b'\x0a\x0a\x5b\x92\x25\x59\x92\x25',
        b'\x28\x0b\x5b\xb2\x25\x5a\x92\x25',
        b'\x4e\x0c\x5b\xd2\x25\x5b\x92\x25',
        b'\x6e\x0d\x5b\xc2\x25\x5a\xa2\x25',
        b'\x0d\x0e\x5b\x92\x25\x5a\x92\x25',
        b'\x3d\x0f\x5b\xa2\x25\x5b\x92\x25',
    ])

  def test_volkswagen_mlb_crc_esp_05(self):
    self.verify_volkswagen_mlb_crc("ESP_05", 0x106, [
        b'\xa5\x00\x96\x04\x00\x00\x00\x30',
        b'\xa4\x01\x96\x04\x00\x00\x00\x30',
        b'\xa4\x02\x95\x04\x00\x00\x00\x30',
        b'\xa6\x03\x96\x04\x00\x00\x00\x30',
        b'\xa1\x04\x96\x04\x00\x00\x00\x30',
        b'\xa0\x05\x96\x04\x00\x00\x00\x30',
        b'\xa3\x06\x96\x04\x00\x00\x00\x30',
        b'\xa3\x07\x97\x04\x00\x00\x00\x30',
        b'\xad\x08\x96\x04\x00\x00\x00\x30',
        b'\xac\x09\x96\x04\x00\x00\x00\x30',
        b'\xaf\x0a\x96\x04\x00\x00\x00\x30',
        b'\xaf\x0b\x97\x04\x00\x00\x00\x30',
        b'\xa7\x0c\x98\x04\x00\x00\x00\x30',
        b'\xa7\x0d\x99\x04\x00\x00\x00\x30',
        b'\xa4\x0e\x99\x04\x00\x00\x00\x30',
        b'\xa5\x0f\x99\x04\x00\x00\x00\x30',
    ])
  ...
  def test_volkswagen_mlb_crc_motor_03(self):
    self.verify_volkswagen_mlb_crc("Motor_03", 0x105, [
        b'\x81\x00\xa8\x17\x80\x46\x00\xfc',
        b'\x8c\x01\xa4\x17\x80\x46\x00\xfc',
        b'\x8f\x02\xa4\x17\x80\x46\x00\xfc',
        b'\x86\x03\xac\x17\x80\x46\x00\xfc',
        b'\x81\x04\xac\x17\x80\x46\x00\xfc',
        b'\x88\x05\xa4\x17\x80\x46\x00\xfc',
        b'\x87\x06\xa8\x17\x80\x46\x00\xfc',
        b'\x82\x07\xac\x17\x80\x46\x00\xfc',
        b'\x8d\x08\xac\x17\x80\x46\x00\xfc',
        b'\x88\x09\xa8\x17\x80\x46\x00\xfc',
        b'\x8b\x0a\xa8\x17\x80\x46\x00\xfc',
        b'\x8a\x0b\xa8\x17\x80\x46\x00\xfc',
        b'\x81\x0c\xa4\x17\x80\x46\x00\xfc',
        b'\x80\x0d\xa4\x17\x80\x46\x00\xfc',
        b'\x8f\x0e\xa8\x17\x80\x46\x00\xfc',
        b'\x8e\x0f\xa8\x17\x80\x46\x00\xfc',
    ])

  def test_volkswagen_mlb_crc_tsk_04(self):
    self.verify_volkswagen_mlb_crc("TSK_04", 0x10E, [
        b'\x72\x70\x44\x09\x00\x00\x00\x40',
        b'\x73\x71\x44\x09\x00\x00\x00\x40',
        b'\x70\x72\x44\x09\x00\x00\x00\x40',
        b'\x71\x73\x44\x09\x00\x00\x00\x40',
        b'\x76\x74\x44\x09\x00\x00\x00\x40',
        b'\x77\x75\x44\x09\x00\x00\x00\x40',
        b'\x74\x76\x44\x09\x00\x00\x00\x40',
        b'\x75\x77\x44\x09\x00\x00\x00\x40',
        b'\x7A\x78\x44\x09\x00\x00\x00\x40',
        b'\x7B\x79\x44\x09\x00\x00\x00\x40',
        b'\x78\x7A\x44\x09\x00\x00\x00\x40',
        b'\x79\x7B\x44\x09\x00\x00\x00\x40',
        b'\x7E\x7C\x44\x09\x00\x00\x00\x40',
        b'\x7F\x7D\x44\x09\x00\x00\x00\x40',
        b'\x7C\x7E\x44\x09\x00\x00\x00\x40',
        b'\x7D\x7F\x44\x09\x00\x00\x00\x40',
    ])

  def test_volkswagen_mlb_crc_hca_01(self):
    self.verify_volkswagen_mlb_crc("HCA_01", 0x126, [
        b'\x8A\x30\x95\x40\x07\xFE\x07\x00',
        b'\x1A\x31\x94\x40\x07\xFE\x07\x00',
        b'\x24\x32\x93\x40\x07\xFE\x07\x00',
        b'\x30\x33\x89\x40\x07\xFE\x07\x00',
        b'\x2F\x34\x7F\x40\x07\xFE\x07\x00',
        b'\xE1\x35\x75\x40\x07\xFE\x07\x00',
        b'\x8A\x36\x77\x40\x07\xFE\x07\x00',
        b'\x9E\x37\x6D\x40\x07\xFE\x07\x00',
        b'\xD7\x38\x63\x40\x07\xFE\x07\x00',
        b'\x58\x39\x59\x40\x07\xFE\x07\x00',
        b'\x48\x3A\x4F\x40\x07\xFE\x07\x00',
        b'\x86\x3B\x45\x40\x07\xFE\x07\x00',
        b'\xC6\x3C\x3B\x40\x07\xFE\x07\x00',
        b'\x08\x3D\x31\x40\x07\xFE\x07\x00',
        b'\x18\x3E\x27\x40\x07\xFE\x07\x00',
        b'\x97\x3F\x1D\x40\x07\xFE\x07\x00',
    ])
